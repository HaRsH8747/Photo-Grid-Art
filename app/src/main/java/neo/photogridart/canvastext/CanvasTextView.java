...
import neo.photogridart.canvastext.CustomRelativeLayout.RemoveTextListener;
...
public class CanvasTextView extends View {
    ...
    public CanvasTextView(Context context, TextData td, Bitmap removeBtm, Bitmap scaleBtm) {
        ...
        this.redPaint.setColor(getResources().getColor(R.color.start_color));
    ...
    public void onDraw(Canvas canvas) {
        ...
        Log.e("ShareConstants.WEB_DIALOG_PARAM_MESSAGE", this.textData.message);
    ...
    public void setNewTextData(TextData textData2) {
    ...
    public void createDeleteDialog(Context paramContext, final View paramView) {
        ...
        final Dialog dialog = new Dialog(paramContext);
