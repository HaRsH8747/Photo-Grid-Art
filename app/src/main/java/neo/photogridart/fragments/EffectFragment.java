...
import neo.photogridart.adapters.MyRecyclerViewAdapter.SelectedIndexChangedListener;
import neo.photogridart.common_lib.MyAsyncTask;
import neo.photogridart.common_lib.Parameter;
import neo.photogridart.common_lib.SeekBarHint;
import neo.photogridart.utils.LibUtility;
import neo.photogridart.utils.LibUtility.ExcludeTabListener;
import neo.photogridart.utils.LibUtility.FooterVisibilityListener;
import java.io.File;
...
public class EffectFragment extends Fragment {
    ...
    class FilterAndAdjustmentTask extends MyAsyncTask<Void, Void, Void> {
        ...
        public void saveImageForThumb(Bitmap filterBitmap2) {
            String resultPath = String.valueOf(Environment.getExternalStorageDirectory().toString()) + "/Frame Thumb/" + "border_" + (EffectFragment.this.parameterGlobal.selectedBorderIndex == 0 ? 0 : EffectFragment.this.parameterGlobal.selectedBorderIndex - 1) + "_thumb" + ".jpg";
            new File(resultPath).getParentFile().mkdirs();
            try {
                OutputStream fileOutputStream = new FileOutputStream(resultPath);
                filterBitmap2.compress(CompressFormat.JPEG, 90, fileOutputStream);
    ...
    private void initAdapters() {
        ...
        this.borderAdapter = new MyRecyclerViewAdapter(LibUtility.borderResThumb, borderL, R.color.blacktransparent, R.color.footer_button_color_pressed, 100);
        ...
        this.textureAdapter = new MyRecyclerViewAdapter(LibUtility.textureResThumb, new RecyclerAdapterIndexChangedListener() {
            public void onIndexChanged(int i) {
                EffectFragment.this.applyChangesOnBitmap();
            }
        }, R.color.blacktransparent, R.color.footer_button_color_pressed, 100);
        ...
        this.overlayAdapter = new MyRecyclerViewAdapter(LibUtility.overlayResThumb, new RecyclerAdapterIndexChangedListener() {
            public void onIndexChanged(int i) {
                EffectFragment.this.applyChangesOnBitmap();
            }
        }, R.color.blacktransparent, R.color.footer_button_color_pressed, 100);
        ...
        this.filterAdapter = new MyRecyclerViewAdapter(LibUtility.filterResThumb, new RecyclerAdapterIndexChangedListener() {
            public void onIndexChanged(int i) {
                EffectFragment.this.applyChangesOnBitmap();
            }
        }, R.color.blacktransparent, R.color.footer_button_color_pressed, 100);
        ...
        textureRecyclerView.setLayoutManager(linearLayoutManager2);
        ...
        overlayRecyclerView.setLayoutManager(linearLayoutManager3);
        ...
        filterRecyclerView.setLayoutManager(linearLayoutManager4);
    ...
    private void setTabBg(int index) {
        if (this.tabButtonList == null) {
            this.tabButtonList = new TextView[14];
            this.tabButtonList[0] = (TextView) getView().findViewById(R.id.ttbutton_fx);
            this.tabButtonList[1] = (TextView) getView().findViewById(R.id.ttbutton_frame);
            this.tabButtonList[2] = (TextView) getView().findViewById(R.id.ttlib_light);
            this.tabButtonList[3] = (TextView) getView().findViewById(R.id.ttlib_texture);
            this.tabButtonList[10] = (TextView) getView().findViewById(R.id.ttlib_blur);
        }
        if (index >= 0) {
  ...
  /*  private void setTabBgEx(int index) {
        if (this.tabButtonList == null) {
            ...
            this.tabButtonList[0] = (TextView) getView().findViewById(R.id.button_fx);
